Leu-Comp-Therm-001.1, rev1, 9/30/1998.
c
c
...
c
c - A 20 x 18 cluster plus one rod in the 19th row:
   22    0                 -105 +104  -153 +152  -204 +203
                           fill=11(0.00 0.00 +17.84)             $20x18 cluster
   23    0                 -105 +109  -155 +153  -204 +203
                           fill=11(0.00 0.00 +17.84)             $single rod
c
...
c   center of center cluster is x=0.
  101   px  -50.320  $left  model boundary (s104 - 30.0)
  104   px  -20.320  $left  boundary (-0.5*20*2.032)
  105   px   20.320  $right boundary ( 0.5*20*2.032)
  108   px   50.320  $right model boundary (s105 + 30.0)
  109   px   18.288  $boundary for single rod in 19th row (s105-2.032)
c
c - global y coordinates:
c   center of center cluster is y=0.
  151   py  -48.288 $model   boundary (s152 - 30.0)
  152   py  -18.288 $cluster boundary (-0.5*18*2.032)
  153   py   18.288 $cluster boundary ( 0.5*18*2.032)
  154   py   50.320 $model   boundary (s155 + 30.0)
  155   py   20.320 $boundary for single rod in 19th row (s153+2.032)
c
