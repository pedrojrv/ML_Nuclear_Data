Leu-Comp-Therm-001.2, rev1, 9/30/1998.
c
c
...
c - Three clusters with water between:
   21    0                 -103 +102  -153 +152  -204 +203  
                           fill=11(-72.880 -17.272 +17.84)    $left   cluster
   22    0                 -105 +104  -153 +152  -204 +203
                           fill=11(-20.320 -17.272 +17.84)    $center cluster
   23    0                 -107 +106  -153 +152  -204 +203
                           fill=11(+72.880 -17.272 +17.84)    $right  cluster
...
c   center of center cluster is x=0.
  101   px -102.880  $left   model boundary (s102 - 30.0)
  102   px  -72.880  $left   cluster, left  boundary (s103 - 20*2.032)
  103   px  -32.240  $left   cluster, right boundary (s104 - 11.92)
  104   px  -20.320  $center cluster, left  boundary (-0.5*20*2.032)
  105   px   20.320  $center cluster, right boundary ( 0.5*20*2.032)
  106   px   32.240  $right  cluster, left  boundary (s105 + 11.92)
  107   px   72.880  $right  cluster, right boundary (s106 + 20*2.032)
  108   px  102.880  $right  model boundary (s107 + 30.0)
c
c - global y coordinates:
c   center of center cluster is y=0.
  151   py  -47.272 $model   boundary (s152 - 30.0)
  152   py  -17.272 $cluster boundary (-0.5*17*2.032)
  153   py   17.272 $cluster boundary ( 0.5*17*2.032)
  154   py   47.272 $model   boundary (s153 + 30.0)
c
