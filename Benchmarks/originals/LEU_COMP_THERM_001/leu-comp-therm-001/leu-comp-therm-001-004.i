Leu-Comp-Therm-001.4, rev1, 9/30/1998.
c
c
...
c - Three clusters with water between:
   21    0                 -103 +102  -153 +152  -204 +203  
                           fill=11(-75.074 -16.256 +17.84)    $left   cluster
   22    0                 -105 +104  -153 +152  -204 +203
                           fill=11(-20.320 -16.256 +17.84)    $center cluster
   23    0                 -107 +106  -153 +152  -204 +203
                           fill=11(+75.074 -16.256 +17.84)    $right  cluster
...
c   center of center cluster is x=0.
  101   px -105.074  $left   model boundary (s102 - 30.0)
  102   px  -75.074  $left   cluster, left  boundary (s103 - 22*2.032)
  103   px  -30.370  $left   cluster, right boundary (s104 - 10.05)
  104   px  -20.320  $center cluster, left  boundary (-0.5*20*2.032)
  105   px   20.320  $center cluster, right boundary ( 0.5*20*2.032)
  106   px   30.370  $right  cluster, left  boundary (s105 + 10.05)
  107   px   75.074  $right  cluster, right boundary (s106 + 22*2.032)
  108   px  105.074  $right  model boundary (s107 + 30.0)
c
c - global y coordinates:
c   center of center cluster is y=0.
  151   py  -46.256 $model   boundary (s152 - 30.0)
  152   py  -16.256 $cluster boundary (-0.5*16*2.032)
  153   py   16.256 $cluster boundary ( 0.5*16*2.032)
  154   py   46.256 $model   boundary (s153 + 30.0)
c
