Leu-Comp-Therm-001.5, rev1, 9/30/1998.
c
c
...
c   center of center cluster is x=0.
  101   px  -97.350  $left   model boundary (s102 - 30.0)
  102   px  -67.350  $left   cluster, left  boundary (s103 - 20*2.032)
  103   px  -26.710  $left   cluster, right boundary (s104 - 6.39)
  104   px  -20.320  $center cluster, left  boundary (-0.5*20*2.032)
  105   px   20.320  $center cluster, right boundary ( 0.5*20*2.032)
  106   px   26.710  $right  cluster, left  boundary (s105 + 6.39)
  107   px   67.350  $right  cluster, right boundary (s106 + 20*2.032)
  108   px   97.350  $right  model boundary (s107 + 30.0)
c
