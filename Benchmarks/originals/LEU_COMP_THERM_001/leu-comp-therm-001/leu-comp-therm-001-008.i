Leu-Comp-Therm-001.8, rev1, 9/30/1998.
c
c
...
c   center of center cluster is x=0.
  101   px  -95.482  $left   model boundary (s102 - 30.0)
  102   px  -65.482  $left   cluster, left  boundary (s103 - 19*2.032)
  103   px  -26.874  $left   cluster, right boundary (s104 - 7.57)
  104   px  -19.304  $center cluster, left  boundary (-0.5*19*2.032)
  105   px   19.304  $center cluster, right boundary ( 0.5*19*2.032)
  106   px   26.874  $right  cluster, left  boundary (s105 + 7.57)
  107   px   65.482  $right  cluster, right boundary (s106 + 19*2.032)
  108   px   95.482  $right  model boundary (s107 + 30.0)
c
