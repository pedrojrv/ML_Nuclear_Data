...
mat = scipy.io.loadmat('LEU_COMP_THERM_001_007_det0.mat')
...
plt.title('Flux-Energy Spectrum for LEU_COMP_THERM_001_007')
plt.savefig('LEU_COMP_THERM_001_007_FluxEnergySpectrum.png')
plt.show()