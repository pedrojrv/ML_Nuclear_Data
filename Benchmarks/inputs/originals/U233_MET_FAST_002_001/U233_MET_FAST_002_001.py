# -*- coding: utf-8 -*-
"""
Created on Tue Dec 22 03:19:10 2020
...
mat = scipy.io.loadmat('U233_MET_FAST_002_001_det0.mat')
...
plt.title('Flux-Energy Spectrum for U233_MET_FAST_002_001')
plt.savefig('U233_MET_FAST_002_001_FluxEnergySpectrum.png')
plt.show()