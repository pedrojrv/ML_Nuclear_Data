...
mat = scipy.io.loadmat('LEU_COMP_THERM_001_005_det0.mat')
...
plt.title('Flux-Energy Spectrum for LEU_COMP_THERM_001_005')
plt.savefig('LEU_COMP_THERM_001_005_FluxEnergySpectrum.png')
plt.show()