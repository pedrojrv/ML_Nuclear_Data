...
mat = scipy.io.loadmat('LEU_COMP_THERM_001_002_det0.mat')
...
plt.title('Flux-Energy Spectrum for LEU_COMP_THERM_001_002')
plt.savefig('LEU_COMP_THERM_001_002_FluxEnergySpectrum.png')
plt.show()
