...
mat = scipy.io.loadmat('HEU_MET_FAST_067_001_det0.mat')
...
plt.title('Flux-Energy Spectrum for HEU_MET_FAST_067_001')
plt.savefig('HEU_MET_FAST_067_001_FluxEnergySpectrum.png')
plt.show()