...
mat = scipy.io.loadmat('LEU_COMP_THERM_001_001_det0.mat')
...
plt.title('Flux-Energy Spectrum for LEU_COMP_THERM_001_001')
plt.savefig('LEU_COMP_THERM_001_001_FluxEnergySpectrum.png')
plt.show()