...
mat = scipy.io.loadmat('LEU_COMP_THERM_001_003_det0.mat')
...
plt.title('Flux-Energy Spectrum for LEU_COMP_THERM_001_003')
plt.savefig('LEU_COMP_THERM_001_003_FluxEnergySpectrum.png')
plt.show()