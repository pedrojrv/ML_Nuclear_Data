...
ETA = 0.8
NUM_ROUND = 10
MAX_BIN_LIST = [300, 10000, 20000, 30000, 40000, 50000] 
...
import nucml.model.building_utils as build_utils # pylint: disable=import-error
    ...
    for l2 in LAMBDA_LIST:
        for max_depth in MAX_DEPTH_LIST:
            for max_bin in MAX_BIN_LIST:
                ...
                RUN_NAME = 'XGB{}_L{}_MB{}_{}_{}_{}{}'.format(max_depth, l2, max_bin, NORMALIZER_TYPE, objective, DATASET, VERSION) 
                ...
                xgb_model = xgb.train(params, dtrain, NUM_ROUND, evallist, evals_result=progress, verbose_eval=False, early_stopping_rounds=10)
