...
parameters_dict = {"max_depth_list":np.arange(150, 320, 10), "min_split_list":[2, 5, 10, 15], "min_leaf_list":[1, 3, 5, 7, 10]}


for mt_strategy in ["one_hot"]:
    for normalizer_type in ["minmax"]:
            ...
            for mss in parameters_dict["min_split_list"]:
                for msl in parameters_dict["min_leaf_list"]:
                    if mss <= msl:
                        ...
                        RUN_NAME = 'DT{}_MSS{}_MSL{}_{}_{}_{}'.format(int(dt_model.get_depth()), mss, msl, normalizer_type, mt_strategy, DATASET) 
