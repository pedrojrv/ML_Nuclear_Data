...
def load_exfor(datapath, num=False, plot_df=False, split=False, frac=0.2, norm=False, log_e=False):
    ...
    # print(df.shape)
    # df = df[(df.Target_Protons != 29) & (df.Target_Neutrons != 36) & (df.MT != "4")]
    # df = df[~df.index.isin(copper.index)]
    # print(df.shape)
    if num:
        ...
        columns_drop = ["Reaction_Notation", "Title", "Institute", "Date", "Reference", "Out", "Target_Element", 
                        "Target_Element_w_A", "EntrySubP", "EXFOR_Status", "Year", "dData", "dEnergy"]  
...
dtype_exfor_p = {'Target_Meta_State': 'object',
                 'MT': 'int64',
                 'Energy': 'float64',
                 'dEnergy': 'float64',
                 'Data': 'float64',
                 ...
                 'I78': 'object',
                 'EntrySubP': 'object',
                 'Target_Protons': 'int64',
                 'Product_Meta_State': 'object',
                 'EXFOR_Status': 'object',
                 'Frame': 'object',
                 'Reaction_Notation': 'object',
                 'Title': 'object',
                 'Year': 'int64',
                 'Institute': 'object',
                 'Date': 'int64',
                 'Reference': 'object',
                 'Out': 'object',
                 'Target_Neutrons': 'int64',
                 'Target_Mass_Number': 'int64',
                 'Target_Element': 'object',
                 'Target_Flag': 'object',
                 'Target_Element_w_A': 'object',
                 'Target_Radius': 'float64',
                 'Prot_Nuc_Rad_Ratio': 'float64',
                 ...
                 'Target_dQ(a)': 'float64',
                 'Target_Q(2B-)': 'float64',
                 'Target_dQ(2B-)': 'float64',
                 'Target_Q(ep)': 'float64',
                 'Target_dQ(ep)': 'float64',
                 'Target_Q(B-n)': 'float64',
                 'Target_dQ(B-n)': 'float64',
                 'Target_S(n)': 'float64',
                 'Target_dS(n)': 'float64',
                 'Target_S(p)': 'float64',
                 'Target_dS(p)': 'float64',
                 'Target_Q(4B-)': 'float64',
                 'Target_dQ(4B-)': 'float64',
                 'Target_Q(d,a)': 'float64',
                 'Target_dQ(d,a)': 'float64',
                 'Target_Q(p,a)': 'float64',
                 'Target_dQ(p,a)': 'float64',
                 'Target_Q(n,a)': 'float64',
                 'Target_dQ(n,a)': 'float64',
                 'Target_Q(g,p)': 'float64',
                 'Target_Q(g,n)': 'float64',
                 'Target_Q(g,pn)': 'float64',
                 'Target_Q(g,d)': 'float64',
                 'Target_Q(g,t)': 'float64',
                 'Target_Q(g,He3)': 'float64',
                 'Target_Q(g,2p)': 'float64',
                 'Target_Q(g,2n)': 'float64',
                 'Target_Q(g,a)': 'float64',
                 'Target_Q(p,n)': 'float64',
                 'Target_Q(p,2p)': 'float64',
                 'Target_Q(p,pn)': 'float64',
                 'Target_Q(p,d)': 'float64',
                 'Target_Q(p,2n)': 'float64',
                 'Target_Q(p,t)': 'float64',
                 'Target_Q(p,3He)': 'float64',
                 'Target_Q(n,2p)': 'float64',
                 'Target_Q(n,np)': 'float64',
                 'Target_Q(n,d)': 'float64',
                 'Target_Q(n,2n)': 'float64',
                 'Target_Q(n,t)': 'float64',
                 'Target_Q(n,3He)': 'float64',
                 'Target_Q(d,t)': 'float64',
                 'Target_Q(d,3He)': 'float64',
                 'Target_Q(3He,t)': 'float64',
                 'Target_Q(3He,a)': 'float64',
                 'Target_Q(t,a)': 'float64'}
