...
for experiment in opt.get_experiments():
    ...
    wandb.init(project=WANDB_PROJECT_NAME, name=RUN_NAME, sync_tensorboard=True, reinit=True, group=GROUP_NAME)
    ...
    history = model.fit(train_dataset,
        ...
        callbacks=get_callbacks("", logs_dir_name=LOGGING_DIR, lr_method=params["lr_schedule_type"], append_wandb=False), # CHANGED WANDB
        verbose=0)
